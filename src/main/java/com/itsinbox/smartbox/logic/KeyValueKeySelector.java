...
import com.itsinbox.smartbox.logic.SimpleKeySelectorResult;
...
public class KeyValueKeySelector extends KeySelector {
   ...
   private boolean algEquals(String sigAlg, String keyAlg) {
      return keyAlg.equalsIgnoreCase("DSA") && sigAlg.equalsIgnoreCase("http://www.w3.org/2000/09/xmldsig#dsa-sha1")?true:keyAlg.equalsIgnoreCase("RSA") && sigAlg.equalsIgnoreCase("http://www.w3.org/2000/09/xmldsig#rsa-sha1");
   }
}
